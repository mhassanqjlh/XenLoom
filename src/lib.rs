...
#[derive(Debug)]
pub struct XenLoomProcessor {
    verbose: bool,
    processed_count: usize,
}

impl XenLoomProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting XenLoom processing");
    
    let mut processor = XenLoomProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = XenLoomProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = XenLoomProcessor::new(false);
